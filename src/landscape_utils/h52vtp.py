...
def h5_to_vtp(surf_file, surf_name='train_loss', log=True, zmax=-1, interp=-1):
    #set th== to True to generate points
    show_points = False
    #set th== to True to generate polygons
    show_polys = True
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interp', default=-1, type=int, help='Interpolate the surface to th== resolution (1000 recommended)')
