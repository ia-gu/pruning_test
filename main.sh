...
python main.py --wandb_run=AdversarialTraining --model=ResNet18 --num_classes=10 --dataset=CIFAR10 --epochs=100 --step=1 --pruning_ratio=100 --importance=None --train_method=AT
